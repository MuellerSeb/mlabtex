...
# -*- coding: utf-8 -*-
#
# mlabtex documentation build configuration file, created by
...
from mlabtex import __version__ as ver
...
man_pages = [(master_doc, "mlabtex", "mlabtex Documentation", [author], 1)]
